...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/cittadino/registration").permitAll()
                .antMatchers("/cittadino/**").hasRole("CITTADINO")
                .antMatchers("/medico/registration").permitAll()
                .antMatchers("/medico/**").hasRole("MEDICO")
                .antMatchers("/datore/registration").permitAll()
                .antMatchers("/datore/**").hasRole("DATORE")
                .and()
                .formLogin()
