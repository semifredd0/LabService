...
@Controller
public class PaypalControllerCittadino {
    
    @Autowired
    PaypalService paymentService;
    
    public static final String SUCCESS_URL = "cittadino/payment/success";
    public static final String CANCEL_URL = "cittadino/payment/cancel";

    @PostMapping("/pay_cittadino")
